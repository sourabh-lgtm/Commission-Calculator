"""Account Manager dashboard — stub (commission plan not yet implemented)."""
from src.dashboards.base import assemble_html

_NAV_LINKS = """
    <div class="nav-section">Coming Soon</div>
    <div class="tab active" onclick="showTab('am-placeholder')">AM Dashboard</div>
...
_TABS_HTML = """
<div id="tab-am-placeholder" class="tab-content active">
  <div class="page-title">Account Manager Dashboard</div>
  <p class="page-sub">Commission plan coming soon</p>
  <div class="panel" style="color:var(--dim);font-size:13px;line-height:1.8">
    <p>The AM commission plan has not been implemented yet.</p>
    <p style="margin-top:8px">Once <code>src/commission_plans/am.py</code> is built and registered, this dashboard will populate with:</p>
    <ul style="margin-top:8px;margin-left:20px">
      <li>Team overview: ARR managed, renewal rate, upsell</li>
      <li>Monthly &amp; quarterly summary</li>
      <li>Individual account-level workings</li>
